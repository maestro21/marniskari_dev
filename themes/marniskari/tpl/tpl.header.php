...
<!-- CSS -->
<LINK REL="StyleSheet" HREF="<?php echo PUB_URL;?>style.php?v=1" TYPE="text/css" MEDIA="screen">
  <link href='https://fonts.googleapis.com/css?family=Open+Sans:300,400,500,600,700,800,900&amp;subset=cyrillic' rel='stylesheet' type='text/css'>
