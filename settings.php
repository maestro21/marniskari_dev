<?php
define('ADM_PASS', '20b9b6ba6dd470c91f0194237eda42e6'); //marniskari2018
...
define('SITE_PATH', BASE_PATH . 'marniskari_dev/');
define('BASE_FOLDER', '');
...
define('HOST_FOLDER', '/marniskari_dev');
